...
public class OrderEntryFrame extends JInternalFrame 
{
  ...
  LOVButton findBtn = new LOVButton();
  static List customerList = DataMan.getCustomers();
  static List productList = DataMan.getProducts();
  LOVButton addBtn = new LOVButton();
  ...
  private void jbInit() throws Exception
  {
    ...
    findBtn.setBounds(new Rectangle(145, 30, 70, 20));
    findBtn.setTitle("List of Customers");
    findBtn.setMessage("Select a customer from the list");
    findBtn.setValues(customerList);
    ...
    addBtn.setText("Add");
    addBtn.setBounds(new Rectangle(305, 90, 60, 23));
    addBtn.setTitle("List of Products");
    addBtn.setMessage("Select a product from the list");
    addBtn.setValues(productList);
  ...
  void addBtn_actionPerformed(ActionEvent e)
  {
    ...
    {
      p = (Product) addBtn.showList();
      if (p != null)
      {
        prodIdTxt.setText(Integer.toString(p.getId()));
      ...
      {
        JOptionPane.showMessageDialog(this,
           "Please enter an id or select a product",
           "Error", JOptionPane.ERROR_MESSAGE);
      }
    }
  }
